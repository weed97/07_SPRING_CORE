...
public class Application {
    ...
    ApplicationContext context =
            new GenericXmlApplicationContext("section03/annotationconfig/subsection02/spring-context.xml");
    ...
    String[] beanNames = context.getBeanDefinitionNames();
        ...
        MemberDAO memberDAO = context.getBean("meberDAO", MemberDAO.class);
